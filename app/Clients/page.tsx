...
const columns = [
    ...
    { name: "DOCUMENT ID", uid: "documentId" },
    ...
    const renderCell = React.useCallback((user: any, columnKey: any) => {
        ...
        switch (columnKey) {
            case "name":
                return (
                    <User
                        avatarProps={{ radius: "lg", src: "https://upload.wikimedia.org/wikipedia/commons/7/7c/Profile_avatar_placeholder_large.png?20150327203541" }}
